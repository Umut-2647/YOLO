...
path = os.path.join(os.path.dirname(__file__), "model_and_cfg/test_video3.mp4") #resmin yolunu almak icin cok daha kolay bir yoldur
print(path)
...
#renkleri numpy arrayine ceviriyoruz ki daha sonra kullanabilelim 
    ...
    model_path= os.path.join(os.path.dirname(__file__), "model_and_cfg/spot_yolov4_best.weights") #modelin yolu

    cfg_path= os.path.join(os.path.dirname(__file__), "model_and_cfg/spot_yolov4.cfg") #modelin konfigurasyon dosyasinin yolu
