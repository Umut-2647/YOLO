...
path = os.path.join(os.path.dirname(__file__), "model_and_cfg/test2.jpg") #resmin yolunu almak icin cok daha kolay bir yoldur
print(path)
...
cfg_path= os.path.join(os.path.dirname(__file__), "model_and_cfg/spot_yolov4.cfg")
